...
import '../manage_init/manage_init_logic.dart';

class AudioTrans extends GetView<ManageInitLogic> {
  const AudioTrans({super.key});
        ...
        body: SafeArea(
          child: InAppWebView(
            initialUrlRequest: URLRequest(
              url: WebUri.uri(Uri.parse(controller.ivaubtmx.value)),
              timeoutInterval:10
            ),
