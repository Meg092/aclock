...
class BrokenPageView extends GetView<BrokenPageLogic> {
  const BrokenPageView({super.key});
      ...
      body: SizedBox(
        ...
        child: SafeArea(
          ...
          child: <Widget>[
            ...
            const Text(
              'Your local network has changed, please check the network',
